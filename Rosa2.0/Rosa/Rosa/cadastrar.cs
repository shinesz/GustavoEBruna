    ...
    public partial class Cadastrar : Form
    {
        ...
        private void Atualizar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string nome = novo.Atualizar(Convert.ToInt32(CodigoBox.Text), "nome", NomeBox.Text);
                // atualizar Nome
                string  dataN = novo.Atualizar(Convert.ToInt32(CodigoBox.Text), "data", DataBox.Text);
                //atualizar telefone
                string peso = novo.Atualizar(Convert.ToInt32(CodigoBox.Text), "peso", PesoBox.Text);
                //atualizar endereco
                string menarca = novo.Atualizar(Convert.ToInt32(CodigoBox.Text), "menarca", MenarcaBox.Text); 
                string menopausa = novo.Atualizar(Convert.ToInt32(CodigoBox.Text), "menopausa", MenoPausaBox.Text);
                //Resposta...
        ...
        private void consultar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               NomeBox.Text = novo.ConsultarNome(Convert.ToInt32(CodigoBox.Text));//Preenchendo o campo CPF
